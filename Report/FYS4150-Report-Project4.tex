...
\end{tabular}
\caption{Expectation values as a function of number of Monte Carlo cycles with the hottest temperature in red.}\label{fig:L20_ex_values}
\end{center}
\end{figure*}
...
We also study the total number of accepted configurations as a function of the total number of Monte Carlo cycles, shown in Fig.~\ref{fig:L20_accepted_configs}a. COMMENTS! 
...
\begin{tabular}{ccc}
	...
	(a) As a function of \# of Monte Carlo cycles.					& (b) As a function of temperature.  \\[6pt]
\end{tabular}
\caption{Number of accepted configurations.}\label{fig:L20_accepted_configs}
\end{center}
\end{figure*}
How does the total number of accepted configurations vary as a function of temperature? This is shown in Fig.~\ref{fig:L20_accepted_configs}b. COMMENT.
