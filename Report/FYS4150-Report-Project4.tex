...
\end{tabular}
\caption{Number of accepted configurations.}\label{fig:L20_accepted_configs_MC}
\end{center}
\end{figure*}
...
In our study of the behavior of our model close to the critical temperature we look at the various expectation values as a function of $T$ for $L = 20, L = 40, L = 60$ and $L = 80$ for $T \in [2.0,2.4]$, shown in Fig.~\ref{fig:ex_values_temp}.
...
\end{tabular}
\end{center}
These data is plotted in Fig.~\ref{fig:time_usage}, approximated by a $L^2$ curve which makes a good fit. The approximation is overestimating at first, but underestimating for large $L$.
